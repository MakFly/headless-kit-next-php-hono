...
CREATE TABLE `__new_permissions` (
	...
	`created_at` text DEFAULT '2026-03-20T23:58:25.660Z' NOT NULL,
	`updated_at` text DEFAULT '2026-03-20T23:58:25.660Z' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`avatar_url` text,
	`created_at` text DEFAULT '2026-03-20T23:58:25.659Z' NOT NULL,
	`updated_at` text DEFAULT '2026-03-20T23:58:25.660Z' NOT NULL
);
--> statement-breakpoint
