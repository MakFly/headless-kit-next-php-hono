...
final class Version20260315500000_CreateSaasTables extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_organizations_plan ON organizations (plan_id)');
        ...
        $this->addSql('CREATE INDEX IDX_subscriptions_org ON subscriptions (organization_id)');
        $this->addSql('CREATE INDEX IDX_subscriptions_plan ON subscriptions (plan_id)');
        ...
        $this->addSql('CREATE INDEX IDX_invoices_org ON invoices (organization_id)');
        ...
        $this->addSql('CREATE INDEX IDX_usage_records_org ON usage_records (organization_id)');
        $this->addSql('CREATE INDEX IDX_usage_records_metric ON usage_records (metric)');
    }
