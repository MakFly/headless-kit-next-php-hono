# CSS Architecture — Next.js BFF (`apps/web`)
...
| Polices custom | `@import 'tailwindcss'` est avant — ajouter `@import` Fontsource dans `globals.css`, `--font-sans` token dans `theme.css` |
