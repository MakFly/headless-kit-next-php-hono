...
/**
 * Client header component for dashboard pages.
 * Uses the Zustand store (no extra fetch).
 */
export function SiteHeaderClient({ title = "Dashboard", subtitle }: SiteHeaderClientProps) {
