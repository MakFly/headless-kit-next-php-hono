...
const features = [
  {
    ...
    description: 'Multi-backend auth with secure HttpOnly cookies and token management out of the box.',
  },
  {
    icon: UsersIcon,
    title: 'Multi-Backend Ready',
    description: 'Swap between Laravel, Symfony, or Node.js backends with a single env variable.',
  },
  {
    icon: KeyIcon,
    title: 'Secure by Default',
    description: 'HttpOnly cookies, secure API proxy, CSRF protection built-in.',
  },
  {
    icon: LockIcon,
