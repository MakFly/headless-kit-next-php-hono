...
class SupportEndpointsTest extends WebTestCase
{
    ...
    {
        $client = static::createClient();
        $client->request('GET', '/api/v1/support/canned-responses');
    ...
    {
        $client = static::createClient();
        $client->request('POST', '/api/v1/support/canned-responses', [], [], [
            'CONTENT_TYPE' => 'application/json',
    ...
    {
        $client = static::createClient();
        $client->request('PUT', '/api/v1/support/canned-responses/fake-id', [], [], [
            'CONTENT_TYPE' => 'application/json',
    ...
    {
        $client = static::createClient();
        $client->request('DELETE', '/api/v1/support/canned-responses/fake-id');
