...
export function SearchSuggestions({ onClose }: SearchSuggestionsProps) {
  ...
  return (
    ...
    >
      ...
      {/* Search panel */}
      <div
        className={`relative z-10 w-full bg-white transition-all duration-350 ease-out ${
          mounted
                ...
                {trendingSearches.map((term, i) => (
                  <li key={term}>
                    <button
                      ...
                      className={`flex w-full items-center gap-3 py-2.5 text-left text-sm tracking-wide transition-colors ${
                        activeIndex === i
                          ? 'text-stone-900'
                  ...
                  {suggestionResults.map((product, i) => (
                    <li key={product.id}>
                      <button
                        ...
                        className={`flex w-full items-center gap-3 py-2.5 text-left text-sm tracking-wide transition-all duration-150 ${
                          activeIndex === i
