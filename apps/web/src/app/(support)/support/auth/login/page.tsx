...
export default function SupportLoginPage() {
  const {
    ...
    toasts: {
      success: { title: "Signed in", description: "Welcome to the Support Center." },
      error: { title: "Sign in failed", description: "Please check your credentials." },
      magicLinkSuccess: { title: "Link sent", description: "Check your email for the sign-in link." },
      magicLinkError: { title: "Link failed", description: "Unable to send magic link." },
      emailRequired: { title: "Email required", description: "Enter your email first." },
    },
  })
    ...
    <div className="space-y-5">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="space-y-2">
          ...
          />
          <Link
            href="/support/auth/forgot-password"
      ...
      <p className="text-center text-sm text-muted-foreground">
        ...
        <Link href="/support/auth/register" className="text-primary underline underline-offset-4">
          Create one
        </Link>
      </p>
    </div>
