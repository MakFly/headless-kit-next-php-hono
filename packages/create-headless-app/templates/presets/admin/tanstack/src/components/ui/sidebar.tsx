...
function Sidebar({
  ...
  collapsible?: 'offcanvas' | 'offExamples' | 'icon' | 'none'
}) {
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          side === 'left'
            ? 'left-0 group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)] group-data-[collapsible=offExamples]:left-[calc(var(--sidebar-width)*-1)]'
            : 'right-0 group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)] group-data-[collapsible=offExamples]:right-[calc(var(--sidebar-width)*-1)]',
          variant === 'floating' || variant === 'inset'
  ...
  return (
    <button
      ...
      className={cn(
        ...
        'hover:group-data-[collapsible=offcanvas]:bg-sidebar group-data-[collapsible=offcanvas]:translate-x-0 group-data-[collapsible=offcanvas]:after:left-full hover:group-data-[collapsible=offExamples]:bg-sidebar group-data-[collapsible=offExamples]:translate-x-0 group-data-[collapsible=offExamples]:after:left-full',
        '[[data-side=left][data-collapsible=offcanvas]_&]:-right-2 [[data-side=left][data-collapsible=offExamples]_&]:-right-2',
        '[[data-side=right][data-collapsible=offcanvas]_&]:-left-2 [[data-side=right][data-collapsible=offExamples]_&]:-left-2',
        className,
      )}
      {...props}
    />
