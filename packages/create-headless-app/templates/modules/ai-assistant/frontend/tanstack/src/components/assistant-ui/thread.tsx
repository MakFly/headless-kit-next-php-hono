  ...
  return (
    <div className="mx-auto my-auto flex w-full max-w-[var(--thread-max-width)] flex-grow flex-col">
      ...
      <div className="grid w-full gap-2 pb-4 md:grid-cols-2">
        <ThreadPrimitive.Suggestion prompt="I have a billing issue" autoSend asChild>
          <Button
            variant="ghost"
            className="h-auto w-full flex-col items-start justify-start gap-1 rounded-3xl border px-5 py-4 text-left text-sm"
          >
            <span className="font-medium">Billing issue</span>
            <span className="text-muted-foreground">Questions about bills or payments</span>
          </Button>
        </ThreadPrimitive.Suggestion>
        <ThreadPrimitive.Suggestion prompt="I can't access my account" autoSend asChild>
          <Button
            variant="ghost"
            className="h-auto w-full flex-col items-start justify-start gap-1 rounded-3xl border px-5 py-4 text-left text-sm"
          >
            <span className="font-medium">Account access</span>
            <span className="text-muted-foreground">Login or password problems</span>
          </Button>
        </ThreadPrimitive.Suggestion>
        <ThreadPrimitive.Suggestion prompt="How do I upgrade my plan?" autoSend asChild>
          <Button
            variant="ghost"
            className="h-auto w-full flex-col items-start justify-start gap-1 rounded-3xl border px-5 py-4 text-left text-sm"
          >
            <span className="font-medium">Upgrade plan</span>
            <span className="text-muted-foreground">Change your subscription</span>
          </Button>
        </ThreadPrimitive.Suggestion>
        <ThreadPrimitive.Suggestion prompt="I'm experiencing a technical issue" autoSend asChild>
          <Button
            variant="ghost"
            className="h-auto w-full flex-col items-start justify-start gap-1 rounded-3xl border px-5 py-4 text-left text-sm"
          >
            <span className="font-medium">Technical issue</span>
            <span className="text-muted-foreground">Report a bug or problem</span>
          </Button>
        </ThreadPrimitive.Suggestion>
      </div>
    </div>
