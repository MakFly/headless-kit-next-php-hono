...
#[Route('/api/v1/admin/reviews/bulk-approve', name: 'api_v1_admin_shop_reviews_bulk_approve', methods: ['POST'])]
#[IsGranted('ROLE_CHECK_admin')]
class BulkApproveReviewsController extends AbstractController
{
