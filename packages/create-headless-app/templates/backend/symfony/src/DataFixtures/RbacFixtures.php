...
class RbacFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $roleAssignments = [
            ...
            'mod@example.com' => $moderatorRole,
            'user@example.com' => $userRole,
            'john@example.com' => $userRole,
            'jane@example.com' => $userRole,
            // Also handle Laravel seeder test users
            'test@test.com' => $userRole,
            'refresh-test@example.com' => $userRole,
        ];
