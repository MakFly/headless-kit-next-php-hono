        ...
        <DialogContent className="max-w-2xl">
          ...
          {selectedUser && selectedUser.roles.length > 0 && (
            <div className="rounded-lg border bg-muted/30 p-4">
              <p className="text-sm font-medium mb-2">Current roles for {selectedUser.name}:</p>
          ...
          <div className="py-2">
            <label className="text-sm font-medium mb-2 block">
              {dialogMode === 'assign' ? 'Select a role to assign:' : 'Select a role to remove:'}
            </label>
            ...
            <div className="rounded-lg border bg-card p-4 space-y-3">
              ...
              <div className="border-t pt-3">
                {(() => {
                  ...
                  return role ? <RolePermissionsDisplay role={role} /> : null;
                })()}
              </div>
            </div>
          )}
          ...
          {dialogMode === 'remove' && selectedRole && (
            <div className="rounded-lg border border-destructive/50 bg-destructive/5 p-4 space-y-3">
              <div className="flex items-center gap-2 text-destructive">
                ...
                <p className="text-sm font-medium">Permissions that will be removed:</p>
              </div>
