 ...
 *     },
 * }
 * @psalm-type BetterAuthConfig = array{
 *     mode?: scalar|Param|null, // Authentication mode: "session", "api", or "hybrid" (both) // Default: "api"
 *     secret?: scalar|Param|null, // Secret key for token encryption - should be set via environment variable // Default: "change_me_in_production"
 *     session?: array{
 *         lifetime?: int|Param, // Default: 604800
 *         cookie_name?: scalar|Param|null, // Default: "better_auth_session"
 *     },
 *     token?: array{
 *         lifetime?: int|Param, // Access token lifetime in seconds // Default: 3600
 *         refresh_lifetime?: int|Param, // Refresh token lifetime in seconds // Default: 2592000
 *     },
 *     oauth?: array{
 *         providers?: array<string, array{ // Default: []
 *             enabled?: bool|Param, // Default: false
 ...
 *             redirect_uri?: scalar|Param|null,
 *         }>,
 *     },
 *     multi_tenant?: array{
 *         enabled?: bool|Param, // Default: true
 *         default_role?: scalar|Param|null, // Default: "member"
 *     },
 *     two_factor?: array{
 *         enabled?: bool|Param, // Enable TOTP two-factor authentication // Default: true
 *         issuer?: scalar|Param|null, // Issuer name shown in authenticator apps // Default: "BetterAuth"
 *         backup_codes_count?: int|Param, // Number of backup codes to generate // Default: 10
 *     },
 *     magic_link?: array{
 *         enabled?: bool|Param, // Enable magic link authentication // Default: false
 *         lifetime?: int|Param, // Magic link token lifetime in seconds (default: 15 minutes) // Default: 900
 *         allow_user_creation?: bool|Param, // Allow magic link to auto-create users on first login // Default: false
 *     },
 *     email_verification?: array{
 *         enabled?: bool|Param, // Enable email verification // Default: true
 *         lifetime?: int|Param, // Email verification token lifetime in seconds (default: 24 hours) // Default: 86400
 *     },
 *     password_reset?: array{
 *         enabled?: bool|Param, // Enable password reset functionality // Default: true
 *         lifetime?: int|Param, // Password reset token lifetime in seconds (default: 1 hour) // Default: 3600
 *     },
 *     guest_sessions?: array{
 *         enabled?: bool|Param, // Enable guest/anonymous sessions // Default: false
 *         lifetime?: int|Param, // Guest session lifetime in seconds (default: 24 hours) // Default: 86400
 *     },
 *     device_tracking?: array{
 *         enabled?: bool|Param, // Enable device tracking // Default: false
 *     },
 *     security_monitoring?: array{
 *         enabled?: bool|Param, // Enable security monitoring and threat detection // Default: false
 *     },
 *     controllers?: array{
 *         enabled?: bool|Param, // Enable bundle controllers. Set to false to use your own. // Default: true
 *     },
 *     security?: array{
 *         auto_configure?: bool|Param, // Auto-configure security.yaml (firewalls, providers, access_control). WARNING: Keep false if you have your own security.yaml with firewalls defined. // Default: false
 *         firewall_name?: scalar|Param|null, // Name of the protected API firewall // Default: "api"
 *         firewall_pattern?: scalar|Param|null, // Regex pattern for the protected API firewall // Default: "^/api"
 *         public_routes_pattern?: scalar|Param|null, // Pattern for public auth routes // Default: "^/auth"
 *     },
 *     cors?: array{
 *         auto_configure?: bool|Param, // Auto-configure nelmio_cors.yaml for auth routes // Default: true
 *     },
 *     routing?: array{
 *         auto_configure?: bool|Param, // Auto-configure routes.yaml prefix for custom controllers // Default: true
 *         custom_controllers_namespace?: scalar|Param|null, // Namespace of custom controllers to prefix // Default: "App\\Controller"
 *     },
 *     openapi?: array{
 *         path_prefix?: scalar|Param|null, // Auth path prefix for OpenAPI docs (e.g., /api/v1/auth). If null, auto-detected from routes. // Default: null
 *         enabled?: bool|Param, // Enable OpenAPI documentation for auth endpoints // Default: true
 *     },
 * }
